...
<head>
    ...
    <title>Deplug Admin Email</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <h2>Welcome to Deplug</h2>
            
            <p>Hi {{FirstName}} {{LastName}},</p>
            
            <p>You've been invited to join the Deplug platform. Please accept your invitation by clicking the button below and registering a new account to get started.</p>
