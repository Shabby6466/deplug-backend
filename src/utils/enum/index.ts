...
export enum ResponseCode {
  ...
  //calendar
  CALENDAR_ALREADY_EXISTS = 1101,
  CALENDAR_NOT_FOUND = 1002,
  INVALID_CALENDAR_DATE = 1003,
  WRONG_CALENDAR_DATE = 1104,

  //missions
  HUNT_ALREADY_SUBMITTED = 701,
  INVALID_WATTS_SAVED = 702,
  HUNT_NOT_FOUND = 703,
  DUPLICATE_REFERRAL_CODE = 704,
  SELF_REFERRAL = 705,
  MORE_THAN_FIVE_INVITES = 706,

  INVALID_REFERRAL_CODE = 800,
}
